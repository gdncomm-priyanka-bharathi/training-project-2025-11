...
public class KafkaConsumerConfig {
    @Bean
    public ConsumerFactory<String, ProductUpdatedEvent> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ProductUpdatedEvent> kafkaListenerFactory() {
